...
vim.pack.add({
	...
	{ src = "https://github.com/mason-org/mason-lspconfig.nvim.git" }, -- ╬ô┬ú├á Added
	...
	-- ╬ô┬Ñ├« Removed nvim-web-devicons (using mini.icons instead)
})
...
require("mason-lspconfig").setup({
	...
	--	ensure_installed = { "lua_ls", "html", "intelephense", "ts_ls", "pyright" },
})

-- =========================================
--  Autocompletion (nvim-cmp) ╬ô├ç├╢ must come BEFORE LSP config
-- =========================================
...
-- =========================================
local lsp = vim.lsp
local capabilities = require("cmp_nvim_lsp").default_capabilities() -- ╬ô┬ú├á Now safe to call
...
-- ╬ô┬ú├á Mock nvim-web-devicons for compatibility
...
vim.api.nvim_create_user_command("PackUpdate", function()
	print("Γëí╞Æ├╢├ñ Updating plugins...")
	vim.pack.update()
	print("╬ô┬ú├á Plugins updated!")
